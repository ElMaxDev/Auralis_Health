...
async function seed() {
  console.log('🌱 Iniciando seed de Auralis Health (Firebase)...\n');
  ...
  try {
    ...
    const knowledge = [
      ...
      {
        type: 'medications',
        title: 'Vademécum básico Auralis Health',
