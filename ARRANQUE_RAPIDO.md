# ARRANQUE RAPIDO — Auralis Health v2 (Firebase)
...
2. Crear proyecto: "auralis-health"
...
FIREBASE_SERVICE_ACCOUNT={"type":"service_account","project_id":"auralis-health","private_key":"-----BEGIN...","client_email":"..."}

# Opcion 2: Variables individuales (copiar del JSON descargado)
FIREBASE_PROJECT_ID=auralis-health
FIREBASE_CLIENT_EMAIL=firebase-adminsdk-xxxxx@auralis-health.iam.gserviceaccount.com
...
git init
git add .
git commit -m "feat: proyecto base Auralis Health v2 con Firebase"
git remote add origin https://github.com/TU_ORG/auralis-health.git
...
```bash
git clone https://github.com/TU_ORG/auralis-health.git
cd auralis-health
npm install
```
